...
export const FormularioCargarFeed: React.FC = () => {
  ...
  const analizarEnlace = async (urlAAnalizar: string) => {
    ...
    try {
      // Simular progresión de pasos para feedback visual enriquecido
  ...
  const manejarSubmit = (e: React.FormEvent) => {
    ...
    toast.success("Contenido publicado con éxito", {
      description: `"${titulo}" ha sido añadido al feed del Observatorio.`,
    });
  ...
  return (
    <div className="flex flex-col w-full gap-8 max-w-6xl mx-auto">
      ...
      <div className="p-6 md:p-8 rounded-[32px] bg-white/95 border border-white/80 shadow-[0_20px_45px_-18px_rgba(9,60,120,0.14),0_1px_3px_rgba(0,0,0,0.03)] backdrop-blur-md flex flex-col gap-4">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3">
          ...
          <button
            ...
            className={`group/btn relative inline-flex items-center justify-center gap-2 px-6 py-3 rounded-2xl text-xs font-semibold tracking-[-0.01em] transition-all duration-300 shadow-sm cursor-pointer whitespace-nowrap ${analizando || !url.trim()
      ...
      <form onSubmit={manejarSubmit} className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        {/* Columna Izquierda: Formulario sin sombras pesadas */}
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-3 text-xs">
              <button
                ...
                className={`flex items-center justify-center gap-2.5 py-3 rounded-2xl border text-xs font-bold transition-all cursor-pointer ${tipo === "noticia"
              ...
              <button
                ...
                className={`flex items-center justify-center gap-2.5 py-3 rounded-2xl border text-xs font-bold transition-all cursor-pointer ${tipo === "youtube"
        ...
        {/* Columna Derecha: Vista Previa en Vivo (Estilo idéntico a las cards de carrusel) */}
